crash-2023-07-31-22-55-45 Grandpa Mumbo.log -> AUTOSCAN REPORT GENERATED BY CLASSIC v7.25.11 Unofficial 
# FOR BEST VIEWING EXPERIENCE OPEN THIS FILE IN NOTEPAD++ OR SIMILAR # 
# PLEASE READ EVERYTHING CAREFULLY AND BEWARE OF FALSE POSITIVES # 
====================================================

Main Error: Unhandled exception "EXCEPTION_ACCESS_VIOLATION" at 0x7FF662258081 Fallout4.exe+20A8081	mov rax, [rcx+0x08]
...
- void* -> SETUPAPI.dll+0002ED3	nop [rax+rax*1], eax) | 1
- void* -> SETUPAPI.dll+000316E	lea r11, [rsp+0xA0]) | 1
- void* -> SETUPAPI.dll+010C000	and bl, cl) | 3
- void* -> XINPUT1_3.dll+00044F5	xor eax, eax) | 1
- void* -> XINPUT1_3.dll+0006EB6	add rsp, 0xA8) | 2
- void* -> XINPUT1_3.dll+000899A	add rsp, 0x28) | 1
- void* -> XINPUT1_3.dll+0008AED	add rsp, 0x28) | 1
